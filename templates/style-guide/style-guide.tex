...
\end{problem}
\begin{proofbox}
	The proof goes here. \hfill\qedsymbol
\end{proofbox}

\begin{problem}
A problem whose final answer must be called out for grading pairs with
\verb|tosubmit| -- it also auto-prefixes the body with a "Solution." label via
\verb|\submitsolution|, separate from the box's own "TO SUBMIT" corner tab.
\end{problem}
\begin{tosubmit}
